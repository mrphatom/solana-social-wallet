...
- [ ] Define and test domain contracts for identities, pairing, recipients, intents, and disabled capabilities.
...
- [ ] Implement the one-time cross-platform account-pairing vertical slice.
...
- [ ] Implement verified recipient resolution and Solana transfer intent creation.
...
- [ ] Add local Discord/Telegram command-event adapters and deterministic demo.
...
- [ ] Add security documentation, architecture decisions, CI, review, release checks, and controlled GitHub publication.
